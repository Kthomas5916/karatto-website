  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#F6F2EB] text-[#121212]">
      ...
      <main>
        ...
        <section id="visuals" className="bg-[#F6F2EB] px-6 py-28">
          <div className="mx-auto max-w-7xl">
          ...
          <div className="relative mx-auto max-w-7xl">
            <div className="grid gap-16 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
              <div>
                ...
                <h2 className="mt-5 font-serif text-5xl leading-tight md:text-6xl">Hospitality management centered around timeless luxury and operational refinement.</h2>
                <p className="mt-8 max-w-xl text-lg leading-8 text-white/72">The Karatto Collection works closely with hotel owners to create emotionally memorable guest experiences while maintaining refined operational standards and elevated luxury positioning.</p>
              </div>
              <div className="grid gap-5 sm:grid-cols-2">
                {ownerValues.map((item) => (
                  <div key={item.title} className="rounded-[1.8rem] border border-[#C6A05B]/30 bg-white/10 p-7 backdrop-blur-sm transition duration-300 hover:-translate-y-1 hover:border-[#C6A05B]/60">
        ...
        <section className="bg-[#111] px-6 py-28 text-white">
          <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1fr_1fr] lg:items-center">
            ...
            <div>
              ...
              <p className="mt-6 text-lg leading-8 text-white/72">Our signature service culture program shapes every guest touchpoint from pre-arrival to departure, ensuring each experience feels elegant, intentional, and emotionally memorable.</p>
        ...
        <section id="contact" className="px-6 py-28">
          <div className="mx-auto max-w-5xl text-center">
            ...
            <h2 className="mt-5 font-serif text-5xl leading-tight text-[#12203A] md:text-6xl">Ready to elevate your hospitality asset?</h2>
            <p className="mx-auto mt-7 max-w-2xl text-lg leading-8 text-black/65">Contact The Karatto Collection to discuss luxury hotel management, operational audits, pre-opening services, or hospitality repositioning opportunities.</p>
